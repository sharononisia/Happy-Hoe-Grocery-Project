...
function generateReceipt() {
    ...
    //     // localStorage.getItem('receiptData', JSON.stringify({ salesAgent, date, customerName, transactionId, items, tax, total, subtotal }));
    ...
    if (salesAgent && date && customerName && transactionId && items.length > 0) {
        // Instead of using localStorage, send a request to the server or redirect to the receipt page with the sale ID
    
        // Redirect to the receipt page with the sale ID (assuming `transactionId` is the sale ID)
